	  ...
	  table.render({
	    ...
	    ,cols: [[ //表头
	    	{field:'cid', title: '序号',fixed: 'left',align:'center',width:'50px'}
		      ,{field: 'sstudentName', title: '学生姓名',align:'center',width:'50px'}
		      ,{field: 'sstudentName', title: '班级',align:'center',width:'50px'}
		      ,{field: 'sNumber', title: '性别',align:'center',width:'50px'}
		      ,{field: 'state', title: '状态', align:'center',width:'80px'}
		      ,{field: 'idcart', title: '学员电话', align:'center',width:'50px'}
		      ,{field: 'phone', title: '家长姓名', align:'center',width:'80px'}
		      ,{field: 'homePhone', title: '家长电话', align:'center',width:'80px'}
		      ,{field: 'sstudentName', title: '籍贯',align:'center',width:'50px'}
		      ,{field: 'sstudentName', title: '入学日期',align:'center',width:'80px'}
