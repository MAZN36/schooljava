...
<body>  
    ...
    <div class="rigtop">
  <button class="layui-btn layui-btn-normal layui-btns"  id="insert">导出Excel</button>
...
layui.use(['table','form'], function(){
  ...
  table.render({
    ...
    ,cols: [[ //表头
      ...
      ,{field: 'problem',width: '450', title: '教员名称',align:'center'}
      ,{field: 'score', title: '总得分',align:'center'}
