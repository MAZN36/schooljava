	...
	$.ajax({
		...
		form.on('select(classselect)', function(data){
			  table.render({
				    ...
				    ,height: 471
				    ,page:false
				    ,url: 'Student_Violate?action=select' //数据接口
				        ,cols: [[ //表头
				        	{type:'numbers', title: '序号'}
				            ,{field: 'vio_Studentid', title: '班级',align:'center'}
				            ,{field: 'vio_Time', title: '活动主题',align:'center'}
				            ,{field: 'vio_Content', title: '时间',align:'center'}
				            ,{field: 'vio_Note', title: '备注',align:'center'}
				        ]]
					  ,id:"idsw"
					  });
			}); 
