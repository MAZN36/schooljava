...
<div class="rigtop">
<a >当前选中:韦邦杠</a>
<button class="layui-btn layui-btn-normal layui-btns"  id="subs">退学</button>
</div>
<div class="divtable">
<div class="lefts">
...
layui.use('table', function(){
  ...
  table.render({
    ...
    ,cols: [[ //表头
      ...
      ,{field: 'studentid', title: '学号', width:120, sort: true, align:'center'}
      ,{field: 'sname', title: '姓名',  width:120,align:'center'}
      ,{field: 'scard', title: '身份证号',  align:'center',width:170}
      ,{field: 'snumber', title: '电话号码',  align:'center',width:150}
      ,{field: 'snativeplace', title: '籍贯',  align:'center',width:150}
      ,{field: 'sstate', title: '状态',  align:'center',width:152}
    ]]
  });
