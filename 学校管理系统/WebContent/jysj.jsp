		  ...
		  table.render({
		    ...
		    ,cols: [[ //表头
		    	{field:'cid', title: '序号',fixed: 'left',align:'center'}
			      ...
			      ,{field: 'type', title: '性别', align:'center'}
			      ,{field: 'time', title: '毕业时间', align:'center'}
			      ,{field: 'ycqrs', title: '年龄', align:'center'}
			      ,{field: 'sjcqrs', title: '籍贯', align:'center'}
			      ,{field: 'cd', title: '学生电话', align:'center'}
			      ,{field: 'zt', title: '家长电话', align:'center'}
			      ,{field: 'qj', title: '面谈结果', align:'center'}
